...
منظومة ERP عربية موجهة لشركات المقاولات الصناعية وMEP والكهرباء والميكانيكا وSteel Structure وPiping وFire Fighting وتركيبات المصانع والصيانة الصناعية.
...
المشروع حاليًا نسخة تجريبية Frontend-Only. المرحلة الأولى الخاصة بالأساس المحلي منفذة، بينما وحدات المحاسبة التشغيلية والمشروعات والمشتريات والمخزون والمستخلصات والتقارير ستُنفذ على مراحل لاحقة.
