...
لا تصل المكونات إلى Dexie مباشرة. قاعدة IndexedDB الحالية هي schema version 6: ترقيات additive تحتفظ بالإصدارات السابقة وتضيف المجالات التجارية والمشتريات والمخزون. الاستلام والتسليم والفحص والمرتجعات تعمل؛ الفوترة والخزينة لم تُنفذ بعد.
