...
لا تصل المكونات إلى Dexie مباشرة. قاعدة IndexedDB الحالية هي schema version 7: ترقيات additive تحتفظ بالإصدارات السابقة وتضيف المحاسبة والمجالات التجارية والمشتريات والمخزون والفوترة والخزينة والتقارير والإقفال.
