...
لا تصل المكونات إلى Dexie مباشرة. قاعدة IndexedDB الحالية هي schema version 10: ترقيات additive تحتفظ بالإصدارات السابقة وتضيف المحاسبة والمجالات التشغيلية بما فيها IPC وMOS والتسليم والاحتجاز.
