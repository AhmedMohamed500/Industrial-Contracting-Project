...
لا تصل المكونات إلى Dexie مباشرة. قاعدة IndexedDB الحالية هي schema version 9: ترقيات additive تحتفظ بالإصدارات السابقة وتضيف المحاسبة والمجالات التجارية والمشتريات والمخزون المتقدم والفوترة والخزينة والتقارير والإقفال.
