...
لا تصل المكونات إلى Dexie مباشرة. قاعدة IndexedDB الحالية هي schema version 11: ترقيات additive تحتفظ بالإصدارات السابقة وتضيف المحاسبة والمجالات التشغيلية والموارد والأصول.
